...
//req.headers : 서버로 요청을 보낼 때 같이 보낸 헤더 정보르 담고 있음.
...
//     JSONP란 COTS(크로스오리진)문제를 피하기 위해 별도의 방식으로 JSON을 가져오는 방식
//res.redirect : 요청경로를 재지정하여 강제 이동한다.
...
//res.sendStatus : 상태 메시저와 함께 HTTP 상태 코드를 전송한다.
